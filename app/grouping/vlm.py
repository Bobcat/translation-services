...
_USER_INSTRUCTION = (
    ...
    "classification.\n\n"
    "3. **Icons:** Ignore graphical icons and pictograms (a calendar, home, gear, "
    ...
    "in rule 6.)\n\n"
    "4. **Table rows:** If an element is a **table row**, put '|' between its fields.\n\n"
    "5. **Field values:** If an element has the format <Field-label> <Field-value>, put "
    "'|' between the label and the value.\n\n"
    "6. **Bullet-list items:** If an element has the format <bullet> <item text>, output the "
    "element as |@blt|@<bullet>|<item text>.\n\n"
    "7. For **font-family**, provide your best best guess for a **specific font name** do "
    "NOT just mention serif or sans-serif.\n\n"
    "8. **Alignment:** Determine the text elements alignment on the document. Put an l for "
