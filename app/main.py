...
from app.routes.common import MAX_UPLOAD_BYTES as _MAX_UPLOAD_BYTES
...
def create_app(settings_path: str | Path | None = None) -> FastAPI:
    ...
    # --- pdf benchmark + document regression (design doc slices 2a-2c) ---
    # Extracted route modules (the approved seam once this file crossed 800 lines);
    # each keeps the same closure-over-settings/runtime style as the routes above.
