...
| `POST` | `/v1/requests/{id}/rerender` | Re-render a completed request's cached translations with new render flags (`render_size_mode`/`erase_fill_mode`/`width_fit_mode`/`size_metric_mode`); no new translation. |
